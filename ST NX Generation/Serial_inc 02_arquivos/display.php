...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=688029675&runauction=1&crr=fbcfaab98700aec6b4dc,,wcvRWYk1ichx2by1SYtIXYjVWbvNWLhJHctE2cpNWZyBXLlN2b21SZ1FXLvRWd01yYulWLsFWayV2ctATNwJzM0ZkMl02bj5ycvJXal1Wdy9mZu8mdpZ3bn5WYy9mRyUiRyUSQzUCc0RHac54f62d36e7f7ac3feb1&rtid=59c43c7658f3b");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c43c7658f3b"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c43c7658f3b').removeAttribute('sandbox');
    }
