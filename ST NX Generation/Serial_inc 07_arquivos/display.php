...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=1260977403&runauction=1&crr=3efbdad3eb5111706c40,AHbnJ2ZuEnYvxWcuImLxJGYm5Gbg5iYxNnLiBnagZWcz5iZgxWduYmdy5CbnZ3duAWbq5ybipWcmBnL2EjMzFDM3VUMm4Gbg1CcsFnam5mdxxWZtwWdqVHbk1mYxxWRxYSRxYiQwYyc3d3a9838e20ba7054ab344e0&rtid=59c43e037db0e");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c43e037db0e"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c43e037db0e').removeAttribute('sandbox');
    }
