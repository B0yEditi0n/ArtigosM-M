...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=161713810&runauction=1&crr=64b462a1d35c0463f229,MzLkECJtJTIs8iMtFSbyEyIl0yLj0WIyATbhMTKjUiMw0WJj8iNtVSNx02LkUDNtNiLp0GLhkiMlMTbwBncwI3c0Ygcl1yLj42MvITKl0SNy8iJu9iNpYzLn4SIy8iByVmByVWAzVGM0QDK49a70392ae4efdb41221&rtid=59c44009d6e10");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c44009d6e10"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c44009d6e10').removeAttribute('sandbox');
    }
