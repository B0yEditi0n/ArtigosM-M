...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=1137617741&runauction=1&crr=0a1fc9e215d895c43530,M3bkFGZtIXYs9mctEWLyF2Yl12bj1SYyBXLhNXajVmcw1SZj9mdtUWdx1ybkVHdtMmbp1CbhlmclNXL1IzMwJzM0ZkMl02bj5ycvJXal1Wdy9mZu8mdpZ3bn5WYy9mRyUiRyUSQzUCc0RHa14c9c1f633773e716d3c&rtid=59c4419d50647");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c4419d50647"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c4419d50647').removeAttribute('sandbox');
    }
