...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=1483017515&runauction=1&crr=00716e0e6676e32cea51,87oo2Kqh7brgOqvh3a4-26rpG6ovGer-yb4t-bpvmqv8GeqvOquhnau9G-oomLuh_qolGOotWqvp-b48n__86__4qo_pH6ovK-vj6bppGau-OqqiPqulq7orKar-Oqi-nui-nej_nOv4iLp235d400ac67f47896186&rtid=59c44223b45ca");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c44223b45ca"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c44223b45ca').removeAttribute('sandbox');
    }
