...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=312041262&runauction=1&crr=e60d9c2ed04ca1d3177c,M3bkFGZtIXYs9mctEWLyF2Yl12bj1SYyBXLhNXajVmcw1SZj9mdtUWdx1ybkVHdtMmbp1CbhlmclNXLwAzMwJzM0ZkMl02bj5ycvJXal1Wdy9mZu8mdpZ3bn5WYy9mRyUiRyUSQzUCc0RHa480045b4e1a355ba735c&rtid=59c4459c7a3bf");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c4459c7a3bf"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c4459c7a3bf').removeAttribute('sandbox');
    }
