...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=1203922123&runauction=1&crr=40896f4cdd6a6e2cd239,M7rkGKptLbos-qstHa7yG6ol26rj2eoyCb7hObqjWqsw2epj-qttXatx2-rkWLttPqrp2OrhmqslOb71L_8wK_80ao8l36rj6-svKbql2aty-qpu_qtpa7rn6aoy-qhyXuhyXegzXOs0SLq63e93842b1735ec59436&rtid=59c445ea998c9");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c445ea998c9"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c445ea998c9').removeAttribute('sandbox');
    }
