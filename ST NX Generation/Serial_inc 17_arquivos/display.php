...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdisplay.com\/a\/display.php?r=968519&treqn=2111561488&runauction=1&crr=e8d5e2126833d545495c,M3bkFGZtIXYs9mctEWLyF2Yl12bj1SYyBXLhNXajVmcw1SZj9mdtUWdx1ybkVHdtMmbp1CbhlmclNXLwADNwJzM0ZkMl02bj5ycvJXal1Wdy9mZu8mdpZ3bn5WYy9mRyUiRyUSQzUCc0RHa6f8462727d4311b9f657&rtid=59c446e318bec");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="59c446e318bec"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('59c446e318bec').removeAttribute('sandbox');
    }
